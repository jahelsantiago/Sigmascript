...
_lr_productions = [
  ...
  ('expression -> INT','expression',1,'p_expression_int_float','calc.py',98),
  ('expression -> FLOAT','expression',1,'p_expression_int_float','calc.py',99),
  ('expression -> NAME','expression',1,'p_expression_var','calc.py',105),
  ('empty -> <empty>','empty',0,'p_empty','calc.py',116),
]
